...
public partial class CyclePhaseDetailViewModel : ObservableObject
{
    ...
    public CyclePhaseDetailViewModel(Func<Task> navigateBackAsync)
    {
    ...
    {
        return new ObservableCollection<CyclePhaseDetailPoint>(points.Select(point => new CyclePhaseDetailPoint
        {
            Title = point.Title,
            Text = point.Text,
    ...
    private static CyclePhaseDetailContent BuildDetail(CyclePhase phase)
    {
        return phase switch
        {
            CyclePhase.Menstrual => new CyclePhaseDetailContent(
                ...
                [
                    Point("Energy has a real reason to dip",
                        "Lower estrogen and progesterone can make heavy work feel expensive. Plan for that instead of blaming yourself.",
                        "BatteryWarning24"),
                    Point("Bleeding changes nutrition math",
                        "Iron and fluid losses are real for some people. Logs help you notice your own pattern.",
                        "Drop24"),
                    Point("Recovery gives you better later weeks",
                        "A slightly easier few days often protects follicular and ovulatory training quality.",
                        "ArrowTrending24")
                ],
                [
                    Point("Iron plus vitamin C",
                        "Beef, eggs, lentils, tofu, spinach, beans, or fortified cereal with citrus, berries, or kiwi.",
                        "Food24"),
                    Point("Warm carbs are useful",
                        "Oats, rice, potatoes, soup, toast, or noodles calm the “nothing sounds good” problem.",
                        "FoodGrains24"),
                    Point("Salt and fluids", "If you feel flat or headachy, add electrolytes, broth, or salty food.",
                        "DrinkCoffee24"),
                    Point("Protein every meal",
                        "Keep muscle repair boring and reliable: yogurt, eggs, fish, chicken, tofu, cottage cheese.",
                        "FoodEgg24")
                ],
                [
                    Point("Low impact first",
                        "Walks, easy cycling, mobility, stretching, light machines, or technique practice.", "Run24"),
                    Point("Strength if symptoms allow",
                        "Use familiar lifts, fewer sets, and leave more reps in reserve.", "Dumbbell24"),
                    Point("Core gently",
                        "Swap hard bracing for breathing drills, dead bugs, or easy carries if cramps are present.",
                        "PersonHeart24")
                ],
                [
                    Point("Do not punish the scale",
                        "Water retention and digestion changes can make weight noisy. Don't rewrite your whole plan from one bloated morning.",
                        "AlertUrgent24"),
                    Point("Watch unusual symptoms",
                        "Severe pain, fainting, heavy bleeding, or sudden changes deserve a clinician, not a tougher workout.",
                        "ShieldError24")
                ]),
            ...
            CyclePhase.Follicular => new CyclePhaseDetailContent(
                ...
                [
                    Point("Learning sticks better",
                        "Higher energy and better coordination make this a strong window for practicing lifts or movements you want to own.",
                        "BrainCircuit24"),
                    Point("Work capacity often improves",
                        "You may tolerate more volume or intensity. Track it so the plan can use it instead of guessing.",
                        "ArrowTrending24"),
                    Point("It sets up the power window",
                        "Good follicular training makes ovulatory work feel earned, not accidental.", "Target24")
                ],
                [
                    Point("Carbs around training",
                        "Rice, oats, fruit, potatoes, pasta, or bread near harder sessions. This is not the week to fear fuel.",
                        "Food24"),
                    Point("Protein stays boring",
                        "Keep the usual target. Muscle growth loves consistency more than dramatic food rules.",
                        "FoodEgg24"),
                    Point("Color for recovery",
                        "Berries, greens, tomatoes, herbs, cruciferous veg, or citrus. Hard training creates recovery demand.",
                        "FoodApple24"),
                    Point("Do not coast under calories",
                        "Feeling good can hide under-eating for a few days. The bill usually arrives in luteal.",
                        "AlertUrgent24")
                ],
                [
                    Point("Push strength", "Add weight, reps, or sets on main lifts while form is still clean.",
                        "Dumbbell24"),
                    Point("Practice new work",
                        "New movements, technique blocks, plyo basics, or intervals fit well here.", "SparkleCircle24"),
                    Point("Use honest progression",
                        "If last week was rough, progress from your actual baseline, not the fantasy version of you.",
                        "CheckmarkCircle24")
                ],
                [
                    Point("Do not double everything",
                        "Energy rising is not permission to add heavy legs, sprints, and a new class all at once.",
                        "AlertUrgent24"),
                    Point("Sleep still decides",
                        "If sleep is bad, keep the progression smaller. Follicular is helpful, not magical.",
                        "WeatherMoon24")
                ]),
            ...
            CyclePhase.Ovulatory => new CyclePhaseDetailContent(
                ...
                [
                    Point("Performance can peak",
                        "Strength, speed, and confidence may line up. Logging helps you know if this is true for you.",
                        "Trophy24"),
                    Point("Joint care matters",
                        "Some people feel more joint looseness here. A better warm-up is not optional fluff.",
                        "PersonHeart24"),
                    Point("It is a measuring week", "Use it to test progress, not to prove your worth.", "Ruler24")
                ],
                [
                    Point("Carbs before and after",
                        "Fruit, rice, oats, potatoes, pasta, sports drink, or toast all work for heavy sessions.",
                        "Food24"),
                    Point("Electrolytes if you sweat",
                        "Add sodium, potassium-rich foods, and fluids so performance doesn't get fake-fragile.",
                        "DrinkCoffee24"),
                    Point("Protein after hard work",
                        "Get a real protein dose within the normal day. No drama, just don't skip it.", "FoodEgg24"),
                    Point("Low appetite is not a plan",
                        "Use easier foods: smoothies, yogurt bowls, wraps, rice bowls, protein shakes.", "FoodApple24")
                ],
                [
                    Point("Heavy compounds",
                        "Squat, hinge, press, pull, hip thrust, or weighted carries if your technique is ready.",
                        "Dumbbell24"),
                    Point("Power and speed", "Short sprints, jumps, med-ball throws, or low-volume explosive work.",
                        "Flash24"),
                    Point("Benchmark, then leave",
                        "Hit the top set, log it, stop chasing extra attempts “just to see.”", "CheckmarkCircle24")
                ],
                [
                    Point("No sloppy maxes", "If reps get twisty, grindy, or weird, the set is done.", "AlertUrgent24"),
                    Point("Warm up longer than your ego wants",
                        "Joints, ankles, hips, shoulders, and core bracing all get a vote here.", "ShieldError24")
                ]),
            ...
            CyclePhase.Luteal => new CyclePhaseDetailContent(
                ...
                [
                    Point("Recovery gets more expensive",
                        "Hard sessions may feel heavier even when the weight did not change.", "BatteryWarning24"),
                    Point("Hunger is information",
                        "A bigger appetite here is common. Pre-planned food beats late-night chaos.", "Food24"),
                    Point("It protects the next cycle",
                        "A good luteal plan prevents the menstrual phase from feeling like a full system crash.",
                        "ShieldCheckmark24")
                ],
                [
                    Point("Protein plus fiber",
                        "Bowls, soups, chili, oats, berries, beans, veg. Protein keeps meals useful; fiber helps cravings.",
                        "FoodEgg24"),
                    Point("Do not delete carbs",
                        "Carbs can help training, mood, and sleep. Choose steady sources before cravings choose for you.",
                        "Food24"),
                    Point("Magnesium and potassium",
                        "Pumpkin seeds, dark chocolate, potatoes, bananas, beans, yogurt, spinach, avocado.",
                        "FoodApple24"),
                    Point("Prep the snack", "Have a planned sweet/salty option ready before hunger wins.", "Cookies24")
                ],
                [
                    Point("Maintain strength",
                        "Keep main lifts, but reduce volume if recovery feels slower. Quality reps over fatigue.",
                        "Dumbbell24"),
                    Point("Tempo and control",
                        "Controlled eccentrics, machines, accessories, and moderate conditioning.", "Timer24"),
                    Point("Late luteal deload",
                        "If PMS, sleep, or soreness spikes, pull back before the crash. That is strategy, not quitting.",
                        "ArrowTrendingDown24")
                ],
                [
                    Point("Do not punish bloating", "Bloating is not a moral failure and not a reason to slash food.",
                        "AlertUrgent24"),
                    Point("Watch mood and sleep patterns",
                        "If this phase consistently feels brutal, track it and bring it to a professional.",
                        "ShieldError24")
                ]),
    ...
    {
        return new CyclePhaseDetailPoint { Title = title, Text = text, IconGlyph = iconGlyph };
    }
    ...
    private void ApplySignalModel(CyclePhase phase)
    {
        ...
        {
            CyclePhase.Menstrual => (Training: 0.35, Nutrition: 0.85, Recovery: 0.95, TrainingText: "Gentle",
                NutritionText: "Repair", RecoveryText: "High"),
            CyclePhase.Follicular => (Training: 0.78, Nutrition: 0.72, Recovery: 0.55, TrainingText: "Build",
                NutritionText: "Fuel", RecoveryText: "Steady"),
            CyclePhase.Ovulatory => (Training: 0.95, Nutrition: 0.82, Recovery: 0.70, TrainingText: "Power",
                NutritionText: "Support", RecoveryText: "Respect"),
            CyclePhase.Luteal => (Training: 0.58, Nutrition: 0.90, Recovery: 0.84, TrainingText: "Control",
                NutritionText: "Stabilize", RecoveryText: "Protect"),
            _ => (Training: 0.7, Nutrition: 0.7, Recovery: 0.5, TrainingText: "Build", NutritionText: "Balanced",
                RecoveryText: "Steady")
        };
    ...
    private static string GetPhaseIconGlyph(CyclePhase phase)
    {
        return phase switch
        {
